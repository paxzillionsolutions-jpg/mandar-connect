  ...
  return (
    <div className="bg-white border border-[#ece4d8] rounded-3xl p-4 shadow-sm">
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            {/* STATUS */}
            <div className="h-7 px-3 rounded-full text-[11px] font-semibold flex items-center shrink-0 bg-[#eef7ee] text-[#2e8b57]">
      ...
      <div className="flex items-center gap-2 mt-4 flex-wrap">
        ...
        <button
          onClick={() => router.push("/profile/advertisements/edit")}
